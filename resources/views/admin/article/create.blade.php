@extends('layouts.admin') @section('title') 这是文章的添加 @endsection @section('title','文章的添加') @section('content')
    ...
    <div class="tpl-block">
        <div class="am-g">
            <div class="tpl-form-body tpl-form-line">
                <form class="am-form tpl-form-line-form" action="/article" method="post" enctype="multipart/form-data">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            @foreach($tag as $v)
                             ...
                             <lable><input type="checkbox" name="tag_id[]" value="{{$v['id']}}">{{$v['name']}}</lable>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <textarea class="" rows="5" name="intro" placeholder="输入个人简介"></textarea>
                    ...
                    <div class="am-form-group">
                     ...
                     <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            ...
                            <script id="editor" type="text/plain"  name="content" style="width:100%;height:700px;"></script>
                        </div>
                    </div>
                    {{csrf_field()}}
                    <div class="am-form-group">
